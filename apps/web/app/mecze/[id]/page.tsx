      ...
      <div className="max-w-2xl mx-auto px-4 pt-8 space-y-6">
        ...
        <div className="bg-[#2e3192]/[0.04] border border-[#2e3192]/15 rounded-2xl p-6">
          ...
          <div className="flex items-center justify-center gap-6">
            <span className="text-lg font-bold text-right flex-1"><Flag team={match.home_team} />{' '}{match.home_team}</span>
            ...
            <span className="text-lg font-bold text-left flex-1"><Flag team={match.away_team} />{' '}{match.away_team}</span>
          </div>
